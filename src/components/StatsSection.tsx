...
const StatsSection: React.FC = () => {
  ...
  const stats = [
    { icon: Code, value: "10+", label: "Projects Completed", color: "text-orange-400" },
    { icon: Clock, value: "1000+", label: "Hours of Coding", color: "text-purple-400" },
    { icon: Users, value: "3", label: "Team Collaborations", color: "text-blue-400" },
    { icon: Server, value: "5", label: "Backend APIs Built", color: "text-green-400" },
  ];
